    ...
    <center>
        ...
        <div class='container'>
            <form action="" method="POST">
                ...
                <input type='text' name="maidName" placeholder="Enter Name">
                <input type='text' name="maidContact" placeholder="Enter Contact Number">
                <input type='text' name="maidAddress" placeholder="Enter Address">
       ...
       if(isset($_POST['submit']))
       {
               $id=$_POST['id'];
               $name=$_POST['maidName'];
               $contact=$_POST['maidContact'];
               $address=$_POST['maidAddress'];
               $query="INSERT INTO `maid`(ID,Name,Maid_contact,Maid_address) values ('$id','$name','$contact','$address')";
