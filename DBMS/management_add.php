...
<body>
    <center>
       ...
       if(isset($_POST['submit']))
       {
               ...
               $flat=$_POST['Flat'];
               $post=$_POST['Post'];
               $query="INSERT INTO `management`(ID,Name,Contact,Flat_number,Post) values ('$id','$name','$contact','$flat','$post')";
       ...
       ?>
        <button type="submit" name="all_owners"class="btn" onclick="location.href='management.php';">Back to Search Page!</button><br>
